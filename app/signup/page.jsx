...
//   const closeModal = () => {
//     setShowModal(false);
//     navigate.push("/account"); // Redirect to account page after closing modal
//   };
...
//   return (
//     <div className="relative host-regular h-screen">
//       <div className="h-[240px]">
//         <Image src="/img/register.jpg" alt="Banner Image" width={1000} height={1000} className="w-full h-full object-cover" />
//       </div>

//       <div className="relative -mt-40 m-4">
//         <form onSubmit={handleSignUp} className="bg-white max-w-xl w-full mx-auto shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-8 rounded-2xl">
//           <div className="mb-12">
...
//               I accept the <a href="/terms" className="text-[#d0721a] hover:underline">Terms and Conditions</a> and <a href="/privacy" className="text-[#d0721a] hover:underline">Privacy Policy</a>
//             </label>
//           </div>
...
//               className="w-full px-2 py-2.5 flex items-center justify-center rounded-md shadow-sm text-gray-800 text-base tracking-wider host-semibold border-none outline-none bg-gray-200 hover:bg-gray-300"
//             >
//               {/* Google Icon */}
//               <svg xmlns="http://www.w3.org/2000/svg" width="22px" fill="#fff" className="inline shrink-0 mr-2" viewBox="0 0 512 512">
//                 <g>
...
//                   <path d="m419.404 58.936-82.933 67.896C313.136 112.246 285.552 103.82 256 103.82c-71.184 0-131.706 47.302-152.649 111.074l-54.594-38.544C92.846 77.388 162.418 0 256 0c71.167 0 133.552 42.24 163.404 58.936z" fill="#f14336" />
//                 </g>
//               </svg>
//               Google Sign Up
//             </button>
